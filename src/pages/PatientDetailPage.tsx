...
import type { PatchPatientStatusRequest, PatientStatus } from "@/types/patients";
...
export default function PatientDetailPage() {
  ...
  const { data: timeline } = useQuery({
    ...
    queryFn: () => patientsApi.getTimeline(id!),
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-surface-800 border border-surface-700 transition-colors"
          >
            Cambiar Estado
          </button>
          <button
          ...
          <div className="bg-surface-900 border border-surface-800 rounded-2xl overflow-hidden">
            {!timeline ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 gap-2">
                <p className="text-slate-400">Sin historial registrado</p>
              </div>
            ) : (
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {consults.items.map((c) => (
                    ...
                    >
                      <td className="px-4 py-3 text-white">{c.specialtyName}</td>
